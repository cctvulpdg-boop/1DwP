...
export const QuestionsPage: React.FC<QuestionsPageProps> = ({
  ...
  const answeredCount = Object.keys(formData.answers).filter(
    (k) => formData.answers[Number(k)] !== undefined && formData.answers[Number(k)] !== null
  ).length;
                              ...
                              <div className="p-3.5 sm:p-4 space-y-3">
                                ...
                                <div className="flex flex-wrap items-center justify-between gap-2.5 pt-1">
                                  <div className="grid grid-cols-2 gap-2.5 w-full sm:w-72">
                                    ...
                                    >
                                      <Check className={`w-4 h-4 ${currentAnswer === 'YA' ? 'stroke-[3]' : ''}`} />
                                      <span>YA</span>
                                    </button>
                                    ...
                                    >
                                      <XCircle className={`w-4 h-4 ${currentAnswer === 'TIDAK' ? 'stroke-[2.5]' : ''}`} />
                                      <span>TIDAK</span>
                                    </button>
                                  </div>
